...
namespace Warcraft_1.Logic_Classes
{
    public static class GroundSprite
    {
        public static Dictionary<int, Point> groundId = new Dictionary<int, Point>()
        {
             ...
             {48, new Point(99, 429)},
             //BridgeHor
             {49, new Point(231, 231)},
             {50, new Point(264, 231)},
             {51, new Point(297, 231)},
             {52, new Point(330, 231)},
             {53, new Point(363, 231)},
             {54, new Point(396, 231)},
             {55, new Point(429, 231)},
             {56, new Point(231, 264)},
             {57, new Point(264, 264)},
             {58, new Point(297, 264)},
             {59, new Point(330, 264)},
             {60, new Point(363, 264)},
             {61, new Point(396, 264)},
             {62, new Point(429, 264)},
             {63, new Point(231, 297)},
             {64, new Point(264, 297)},
             {65, new Point(297, 297)},
             {66, new Point(330, 297)},
             {67, new Point(363, 297)},
             {68, new Point(396, 297)},
             {69, new Point(429, 297)},
             //Roads
             {70, new Point(396, 396)},
             {71, new Point(429, 396)},
             {72, new Point(429, 429)},
             {73, new Point(429, 462)},
             {74, new Point(396, 132)},
             {75, new Point(429, 132)},
             {76, new Point(462, 132)},
             {77, new Point(363, 165)},
             {78, new Point(396, 165)},
             {79, new Point(429, 165)},
